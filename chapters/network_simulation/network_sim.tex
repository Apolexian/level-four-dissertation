...
Using the different links, we then transferred a file of equal size using the various QUIC implementations described in Chapter~\ref{section:quic_impl} for the evaluation of QUIC implementations.
